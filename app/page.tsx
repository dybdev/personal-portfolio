  ...
  return (
    <main id="main">
      ...
      >
        ...
        <Reveal className="mt-7 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <h2
            id="work-title"
        ...
        <div className="mx-auto grid max-w-[1600px] gap-10 px-gutter py-20 md:grid-cols-12 md:gap-12 md:py-28">
          <div className="md:col-span-4">
            ...
            <Asterisk
              aria-hidden="true"
              strokeWidth={0.8}
              className="mt-14 hidden size-40 md:block"
            />
          </div>
      ...
      >
        ...
        <ArrowDownRight
          aria-hidden="true"
          strokeWidth={1}
          className="hidden size-16 self-end justify-self-end md:col-span-1 md:block"
        />
      </section>
    </main>
  );
